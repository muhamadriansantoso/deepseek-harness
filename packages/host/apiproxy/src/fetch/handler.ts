...
import {
  ...
  workspaceSetDefaultSkillsRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'workspace.setDefaultSkills': { schema: workspaceSetDefaultSkillsRequestSchema, invoke: (api, r) => api.workspace.setDefaultSkills(r) },
