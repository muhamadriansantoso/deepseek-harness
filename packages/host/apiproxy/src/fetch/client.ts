...
import {
  ...
  workspaceSetDefaultSkillsValueSchema,
...
export interface IApiClient {
  ...
  workspace: {
    ...
    setDefaultSkills(payload: RequestPayload<'workspace.setDefaultSkills'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'workspace.setDefaultSkills'>>>
  }
  skills: {
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'workspace.setDefaultSkills': workspaceSetDefaultSkillsValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly workspace: IApiClient['workspace'] = {
    ...
    setDefaultSkills: (payload, signal) => this.callUnary('workspace.setDefaultSkills', payload, signal),
  }
