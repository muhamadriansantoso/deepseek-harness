...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('device-offline'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  ...
  z.object({ code: z.literal('workspace-forbidden'), message: z.string(), details: z.object({ path: z.string() }) }),
