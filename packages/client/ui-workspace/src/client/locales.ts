...
export const zh = {
  ...
  'menu.defaultSkill': '默认技能',
  'defaultSkill.title': '设置默认技能',
  'defaultSkill.description': '选择将为此工作区中的所有会话自动加载的技能。这些技能会被注入到会话上下文中，无需手动调用。',
  'defaultSkill.clear': '清除默认技能',
  'defaultSkill.cleared': '已清除默认技能',
  'defaultSkill.loading': '正在加载技能列表…',
  'defaultSkill.empty': '没有可用的技能。',
  'save': '保存',
  'menu.fork': '分叉会话',
...
export const en = {
  ...
  'menu.defaultSkill': 'Default Skills',
  'defaultSkill.title': 'Set Default Skills',
  'defaultSkill.description': 'Select skills that will be auto-loaded for every session in this workspace. Each skill body is injected into the session context without requiring an explicit `skill` tool call.',
  'defaultSkill.clear': 'Clear default skills',
  'defaultSkill.cleared': 'Default skill cleared',
  'defaultSkill.loading': 'Loading skills…',
  'defaultSkill.empty': 'No skills available.',
  'save': 'Save',
