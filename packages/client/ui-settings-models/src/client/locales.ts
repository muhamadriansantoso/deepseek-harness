...
export const en = {
  ...
  adminOnly: 'Only admins may add or change providers; your model controls are read-only.',
  ...
  reasoningEffortsUnset: 'Not configured',
  reasoningEffortsNonReasoning: 'Non-reasoning model',
  reasoningEffortsCustom: 'Custom levels',
  reasoningEffortsHint: 'Levels offered in the composer selector; unset offers the standard levels, and every level beyond Off needs the wire value the endpoint expects.',
  reasoningLevel: 'Effort level',
  reasoningWire: 'Wire value',
  reasoningOffWireHint: 'Empty means the request sends no reasoning parameter',
  reasoningEffortsInvalid: 'Reasoning efforts must declare levels with their wire values.',
  reasoningEffortsNeedLevel: 'Reasoning efforts must offer at least one level beyond Off.',
  reasoningEffortsWireRequired: 'Every level beyond Off needs the wire value the endpoint expects.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  adminOnly: '仅管理员可添加或修改提供方；你的模型控件为只读。',
  ...
  reasoningEffortsUnset: '未配置',
  reasoningEffortsNonReasoning: '非推理模型',
  reasoningEffortsCustom: '自定义档位',
  reasoningEffortsHint: '在输入框选择器中提供的档位；未配置时提供标准档位，Off 之外的每个档位都需要填写端点期望的取值。',
  reasoningLevel: '档位',
  reasoningWire: '取值',
  reasoningOffWireHint: '留空表示请求不发送推理参数',
  reasoningEffortsInvalid: '推理档位需要声明提供的档位及其取值。',
  reasoningEffortsNeedLevel: '推理档位至少需要提供 Off 之外的一个档位。',
  reasoningEffortsWireRequired: 'Off 之外的每个档位都需要填写端点期望的取值。',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
